...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var BTN_TEXTO_ENVIANDO = '<span class="contacto-spinner"></span> Enviando...';
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (errores.length > 0) {
            var primerCampo = form.querySelector('.contacto-form__field--error input, .contacto-form__field--error select, .contacto-form__field--error textarea');
        ...
        .then(function (data) {
            if (data.success) {
                ...
                mostrarResultado('error', data.data.message || 'Ocurrió un error. Intenta nuevamente.');
            }
        })
        .catch(function (err) {
            mostrarResultado('error', 'No se pudo conectar con el servidor. Verifica tu conexión e intenta de nuevo.');
    ...
    var campos = form.querySelectorAll('.contacto-form__input, .contacto-form__select, .contacto-form__textarea');
    for (var i = 0; i < campos.length; i++) {
        campos[i].addEventListener('input', function () {
            ...
            var msgEl = field ? field.querySelector('.contacto-form__error-msg') : null;
    ...
    function limpiarErrores() {
        var erroresVisibles = form.querySelectorAll('.contacto-form__field--error');
